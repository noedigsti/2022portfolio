...
export default function NotFound() {
  return (
    <Container title={"Hey! That page doesn't exist!"}>
      <div className="flex flex-col justify-center items-start max-w-2xl mx-auto mb-16">
        ...
        <Link href="/">
          <button className="p-1 sm:p-4 w-64 font-bold mx-auto bg-gray-200 dark:bg-gray-800 text-center rounded-md text-black dark:text-white">
            Return Home
          </button>
        </Link>
      </div>
